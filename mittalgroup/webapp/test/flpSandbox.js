		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Print Out",
									"targetURL": "#zymgproskprintoutmittalgroup-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zymgproskprintoutmittalgroup-display": {
								"semanticObject": "zymgproskprintoutmittalgroup",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zymgproskprintout.mittalgroup",
									"url": sap.ui.require.toUrl("zymgproskprintout/mittalgroup")
								}
							}
						}
					}
